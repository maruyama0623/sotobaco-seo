...
![kintoneのお知らせ掲示板にアプリへのリンクを設定する画面。リンクテキスト・URL・開き方を設定してポータルのお知らせからアプリに直接アクセスできるようにする](/images/portal/kintone_portal-announce-link.png)
...
![kintoneでスペースを新規作成する画面。スペース名・公開範囲（参加メンバーのみ）・カバー画像を設定して部署別スペースを作れる](/images/portal/kintone_space-create.png)
...
![kintoneのアプリのアクセス権設定画面。営業部組織にレコードの閲覧・追加・編集・削除権限を付与している設定例](/images/portal/kintone_app-access-rights.png)
...
![kintoneポータルのJavaScriptカスタマイズ画面。部署別のボタンをHTMLで実装しているが、コードの知識が必要で属人化リスクが高い](/images/portal/kintone_portal-js-customize.png)
...
![ソトバコポータルの主な機能。タブ整理・閲覧権限・グループ化・色分け・外部リンク・スマートフォン対応の6つの特徴をひとつの画面で確認できる](/images/portal/portal_features.png)
...
![ソトバコポータルの編集画面。アプリカードをドラッグ&ドロップするだけでレイアウトを変更でき、専門知識不要で管理者1人でもポータルを整理できる](/images/portal/portal_drag-drop.png)
...
![ソトバコポータルの右サイドバー。未処理・通知・アプリ一覧の3つのウィジェットを表示でき、kintoneの重要情報を一画面で確認できる](/images/portal/portal_sidebar.png)
...
![ソトバコポータルの限定公開機能の説明図。設定済みユーザーにはカスタマイズされたポータルが表示され、未設定ユーザーにはいつも通りのkintoneポータルが表示される](/images/portal/portal_limited-public.png)
