...
export const comparisonRows: ComparisonRow[] = [
  { label: "タブ上限", href: "/features/#tab", free: "4タブまで", light: "無制限", standard: "無制限" },
  { label: "グラフ埋め込み", href: "/features/#graph", free: "各1個まで/1タブ", light: "無制限", standard: "無制限" },
  { label: "通知/未処理/アプリ一覧", href: "/features/#notification", free: "○", light: "○", standard: "○" },
  { label: "グループ説明文", href: "/features/#group", free: "×", light: "○", standard: "○" },
  { label: "全体アナウンス", href: "/features/#announce", free: "×", light: "○", standard: "○" },
  { label: "アナウンス表示件数設定", href: "/features/#announce", free: "×", light: "○", standard: "○" },
  { label: "アナウンスカテゴリ設定", href: "/features/#announce", free: "×", light: "×", standard: "○" },
  { label: "スペースリンク", href: "/features/#space-link", free: "×", light: "×", standard: "○" },
  { label: "スペース単位ポータル", href: "/features/#space", free: "×", light: "×", standard: "無制限" },
  { label: "メンバー上限", href: "/features/#member", free: "1名", light: "2名", standard: "5名" },
];
...
export const mainFeatures: Feature[] = [
  {
    ...
    image: "/images/portal/portal_overview.png",
  ...
  },
  {
    ...
    image: "/images/portal/smartphone_overview.png",
